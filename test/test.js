  ...
  describe("#palindrome", function () {
    describe("#letters", function () {
      ...
      it("should return true for a mixed-case palindrome", function () {
        ...
        mixedcheck = /[a-z]/.test(mixedCase) && /[A-Z]/.test(mixedCase);
        palicheck = mixedCase.palindrome();
        assert(mixedcheck && palicheck);
      });

      phraseWithPunctuation = new Phrase("Madam, I’m Adam");
